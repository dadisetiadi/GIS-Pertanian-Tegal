  ...
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div id="pages_maincontent">
                ...
                <div class="buttons-row">
                    <a href="<?=url('data_luaspanen_tegalbarat')?>" class="tab-link button active">Data Luas Panen</a>
                    <a href="<?=url('data_luassawah_tegalbarat')?>" class="tab-link button">Data Luas Sawah</a>
                </div>
