<?php
  $title="Data Kelurahan di Kecamatan Tegal Timur"; 
?> <!-- Judul Halaman -->
...
<div class="pages">
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div class="buttons-row">
                    <a href="<?=url('data_luaspanen_tegaltimur')?>" class="tab-link button active">Data Luas Panen</a>
                    <a href="<?=url('data_luassawah_tegaltimur')?>" class="tab-link button">Data Luas Sawah</a>
