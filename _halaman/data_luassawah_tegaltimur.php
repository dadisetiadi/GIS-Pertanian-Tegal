...
<div class="pages">
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div class="buttons-row">
                    <a href="<?=url('data_luaspanen_tegaltimur')?>" class="tab-link button">Data Luas Panen</a>
                    <a href="<?=url('data_luassawah_tegaltimur')?>" class="tab-link button active">Data Luas Sawah</a>
            ...
            <div class="table-responsive">
                ...
                <h5>Data Luas Lahan Sawah</h5>
                    ...
                    <thead class="thead-dark">
                        ...
                        <th scope="col-sm"><p class="text-justify">Nama Kelurahan</p></th>
