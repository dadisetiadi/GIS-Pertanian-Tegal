  ...
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div id="pages_maincontent">
                 <div class="buttons-row" role="group">
                    <a href="<?=url('data_sayuran_tegalselatan')?>" class="tab-link active button">Tegal Selatan</a>
                    <a href="<?=url('data_sayuran_tegaltimur')?>" class="tab-link button">Tegal Timur</a>
