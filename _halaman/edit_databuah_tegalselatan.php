  ...
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div id="pages_maincontent">
                 <div class="buttons-row" role="group">
                    <a href="<?=url('edit_databuah_tegalselatan')?>" class="tab-link active button">Tegal Selatan</a>
                    <a href="<?=url('edit_databuah_tegaltimur')?>" class="tab-link button">Tegal Timur</a>
                    <a href="<?=url('edit_databuah_tegalbarat')?>" class="tab-link button">Tegal Barat</a>
     ...
     <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                <p> </p>
                <h5>Data Jumlah Panen Buah Kecamatan Tegal Selatan</h5>
