     ...
     <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?=url($url2.'&ubah&id='.$data['id_kecamatan'])?>" class="btn btn-success external"> <i class="external"></i>Ubah</a>
                    <a href="<?=url($url.'&hapus&id='.$data['id_kecamatan'])?>" class="btn btn-danger external" onclick="return confirm('Hapus data?')"> <i class="external">Hapus</i></a> </a>
                    </td>
            ...
            <a href="<?=url('halaman_admin')?>" class="btn btn-primary external"> Kembali</a>
        </div>
        </div>
