  ...
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div id="pages_maincontent">
                 <div class="buttons-row" role="group">
                    ...
                    <a href="<?=url('edit_datasayuran_tegalbarat')?>" class="tab-link active button">Tegal Barat</a>
     ...
     <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                <p> </p>
                <h5>Data Luas Panen & Produksi Tanaman Sayuran di Kecamatan Tegal Barat</h5>
