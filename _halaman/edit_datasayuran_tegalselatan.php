<?php
  $title="Edit Data"; 
  $url3='tambah_sayuran_tegalselatan'; 
  ...
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <div id="pages_maincontent">
                 <div class="buttons-row" role="group">
                    <a href="<?=url('edit_datasayuran_tegalselatan')?>" class="tab-link active button">Tegal Selatan</a>
                    <a href="<?=url('edit_datasayuran_tegaltimur')?>" class="tab-link button">Tegal Timur</a>
     ...
     <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                <p> </p>
                <h5>Data Luas Panen & Produksi Tanaman Sayuran di Kecamatan Tegal Selatan</h5>
