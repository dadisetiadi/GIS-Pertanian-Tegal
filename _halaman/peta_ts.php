<?php
  $title="Peta Kecamatan Tegal Selatan"; 
?> <!-- Judul Halaman -->
...
<div class="pages">
  <div data-page="tables" class="page no-toolbar no-navbar">
    ...
    <h2 class="page_title">Peta Kelurahan di Kwecamatan Tegal Selatan</h2> 
    ...
    layer: L.tileLayer('http://{s}.tile.thunderforest.com/outdoors/{z}/{x}/{y}.png')
      ...
      function highlightFeature(e) {
        ...
        <?php 
        include "koneksi.php";
        $data = mysqli_query($connection,"SELECT * FROM tb_produksi_tegalselatan order by id_kelurahan");
