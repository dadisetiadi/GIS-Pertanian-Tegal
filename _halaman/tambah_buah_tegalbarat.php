...
<?php
  $title="Edit Data"; 
  $url3='tambah_buah_tegalbarat'; 
  $url='edit_buah_tegalbarat';
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"INSERT into tb_buah_tb (nama_buah, jumlah_panen) values('$nama_buah','$jumlah_panen')");
    ?>
