...
<?php
  $title="Edit Data"; 
  $url3='tambah_buah_tegaltimur'; 
  $url='edit_buah_tegaltimur';
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"INSERT into tb_buah_tegaltimur (nama_buah, jumlah_panen) values('$nama_buah','$jumlah_panen')");
    ?>
