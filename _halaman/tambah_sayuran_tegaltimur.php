...
<?php
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"INSERT into tb_sayuran_tegaltimur (nama_sayuran, luas_panen_sayuran, produksi_sayuran) values('$nama_sayuran','$luas_panen_sayuran','$produksi_sayuran')");
    ?>
