...
<?php
  $title="Edit Data"; 
  $url2='ubah_buah_margadana'; 
  $url='edit_databuah_margadana';
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"UPDATE tb_buah_margadana set nama_buah='$nama_buah', jumlah_panen='$jumlah_panen' where id_buah='$id_buah'");
    ?>
...
if(isset($_GET['hapus'])){
      include 'koneksi.php';
      $id_buah = $_GET['id'];
      mysqli_query($connection,"DELETE from tb_buah_margadana where id_buah='$id_buah'");
}
if(isset($_GET['ubah']) AND isset($_GET['id'])) {
  $id=$_GET['id'];
  include "koneksi.php";
  $data = mysqli_query($connection,"SELECT * from tb_buah_margadana where id_buah='$id'");
    ...
    <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                       ...
                       <?php
                        include "koneksi.php";
                        $query = mysqli_query($connection,"SELECT * FROM tb_buah_margadana ORDER BY id_buah");
                        ?>
                    <thead>
                    <tr>
                      <th>Nama buah</th>
