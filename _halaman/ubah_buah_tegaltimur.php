...
<?php
  $title="Edit Data"; 
  $url2='ubah_buah_tegaltimur'; 
  $url='edit_databuah_tegaltimur';
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"UPDATE tb_buah_tegaltimur set nama_buah='$nama_buah', jumlah_panen='$jumlah_panen' where id_buah='$id_buah'");
    ?>
  
  <script type="text/javascript">
    window.alert("Sukses Diubah");
    window.location.href="<?=url('edit_databuah_tegaltimur')?>";
  </script>
...
if(isset($_GET['hapus'])){
      include 'koneksi.php';
      $id_buah = $_GET['id'];
      mysqli_query($connection,"DELETE from tb_buah_tegaltimur where id_buah='$id_buah'");
}
if(isset($_GET['ubah']) AND isset($_GET['id'])) {
  $id=$_GET['id'];
  include "koneksi.php";
  $data = mysqli_query($connection,"SELECT * from tb_buah_tegaltimur where id_buah='$id'");
  ...
  <div class="container">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <a href="<?=url('edit_databuah_tegaltimur')?>" class="btn btn-danger external"> Kembali</a>
      </div>
    ...
    <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                       ...
                       <?php
                        include "koneksi.php";
                        $query = mysqli_query($connection,"SELECT * FROM tb_buah_tegaltimur ORDER BY id_buah");
                        ?>
                    <thead>
                    <tr>
                      <th>Nama buah</th>
