...
<?php
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"UPDATE tb_sayuran_tegalbarat set nama_sayuran='$nama_sayuran', luas_panen_sayuran='$luas_panen_sayuran', produksi_sayuran='$produksi_sayuran' where id_sayuran='$id_sayuran'");
    ?>
...
if(isset($_GET['hapus'])){
      include 'koneksi.php';
      $id_sayuran = $_GET['id'];
      mysqli_query($connection,"DELETE from tb_sayuran_tegalbarat where id_sayuran='$id_sayuran'");
}
if(isset($_GET['ubah']) AND isset($_GET['id'])) {
  $id=$_GET['id'];
  include "koneksi.php";
  $data = mysqli_query($connection,"SELECT * from tb_sayuran_tegalbarat where id_sayuran='$id'");
    ...
    <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                       ...
                       <?php
                        include "koneksi.php";
                        $query = mysqli_query($connection,"SELECT * FROM tb_sayuran_tegalbarat ORDER BY id_sayuran");
                        ?>
                    <thead>
                    <tr>
                      <th>Nama sayuran</th>
