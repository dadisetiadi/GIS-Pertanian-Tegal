...
<?php
  $title="Edit Data"; 
  $url2='ubah_sayuran_tegalselatan'; 
  $url='edit_datasayuran_tegalselatan';
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"UPDATE tb_sayuran_tegalselatan set nama_sayuran='$nama_sayuran', luas_panen_sayuran='$luas_panen_sayuran', produksi_sayuran='$produksi_sayuran' where id_sayuran='$id_sayuran'");
    ?>
  
  <script type="text/javascript">
    window.alert("Sukses Diubah");
    window.location.href="<?=url('edit_datasayuran_tegalselatan')?>";
  </script>
...
if(isset($_GET['hapus'])){
      include 'koneksi.php';
      $id_sayuran = $_GET['id'];
      mysqli_query($connection,"DELETE from tb_sayuran_tegalselatan where id_sayuran='$id_sayuran'");
}
if(isset($_GET['ubah']) AND isset($_GET['id'])) {
  $id=$_GET['id'];
  include "koneksi.php";
  $data = mysqli_query($connection,"SELECT * from tb_sayuran_tegalselatan where id_sayuran='$id'");
  ...
  <div class="container">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <a href="<?=url('edit_sayuran_tegalselatan')?>" class="btn btn-danger external"> Kembali</a>
      </div>
    ...
    <div class="page_single layout_fullwidth_padding">          
            <div class="table-responsive">
                <table class="table">
                       ...
                       <?php
                        include "koneksi.php";
                        $query = mysqli_query($connection,"SELECT * FROM tb_sayuran_tegalselatan ORDER BY id_sayuran");
                        ?>
                    <thead>
                    <tr>
                      <th>Nama sayuran</th>
