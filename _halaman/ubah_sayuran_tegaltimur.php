...
<?php
  ...
  <div data-page="about" class="page no-toolbar no-navbar">
    ...
    <?php
        ...
        mysqli_query($connection,"UPDATE tb_sayuran_tegaltimur set nama_sayuran='$nama_sayuran', luas_panen_sayuran='$luas_panen_sayuran', produksi_sayuran='$produksi_sayuran' where id_sayuran='$id_sayuran'");
    ?>
  
  <script type="text/javascript">
    window.alert("Sukses Diubah");
    window.location.href="<?=url('edit_datasayuran_tegaltimur')?>";
  </script>
...
if(isset($_GET['hapus'])){
      include 'koneksi.php';
      $id_sayuran = $_GET['id'];
      mysqli_query($connection,"DELETE from tb_sayuran_tegaltimur where id_sayuran='$id_sayuran'");
}
if(isset($_GET['ubah']) AND isset($_GET['id'])) {
  $id=$_GET['id'];
  include "koneksi.php";
  $data = mysqli_query($connection,"SELECT * from tb_sayuran_tegaltimur where id_sayuran='$id'");
  ...
  <div class="container">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <a href="<?=url('edit_sayuran_tegaltimur')?>" class="btn btn-danger external"> Kembali</a>
      </div>
