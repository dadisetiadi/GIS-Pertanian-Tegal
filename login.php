...
<!-- Mirrored from maxartkiller.com/website/Fimobile/Fimobile-HTML/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 04:44:51 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="row no-gutters login-row">
            <div class="col align-self-center px-3 text-center">
                ...
                <form class="form-signin mt-3 ">
                    ...
                    <a href="forgot-password.html" class="mt-4 d-block">Forgot Password?</a>
        ...
        <div class="row mx-0 bottom-button-container">
            <div class="col">
                <a href="index-2.html" class="btn btn-default btn-lg btn-rounded shadow btn-block">Login</a>
            </div>
        </div>
        <!-- login buttons -->
    </div>
...
<!-- Mirrored from maxartkiller.com/website/Fimobile/Fimobile-HTML/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 04:44:52 GMT -->
</html>
